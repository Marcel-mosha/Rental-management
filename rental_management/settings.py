...
SECRET_KEY = 'django-insecure-1&-=k(p(is!&gxya65gm)m*4s&c411bzm^nkjj!hzac!$f#vi('
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('POSTGRES_DB', 'rental_management'),
...
# TIME_ZONE is set at the bottom of file for Tanzania
...
DEFAULT_FROM_EMAIL = 'noreply@rentalpoa.co.tz'
